...
void setup() {
   ...
   // Serial.println("msfanPwmValue initialized to: " + String(msfanPwmValue));
    ...
    if (SerialBT.available()) {
       ...
       // command.trim();  // Убираем лишние пробелы
        ...
        if (command.startsWith("heater_state:") && heaterManualMode) {
          ...
          //  SerialBT.println("Heater state set to: " + String(manualHeaterState));
        }
